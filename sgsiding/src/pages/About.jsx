  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <section className="bg-white/10 rounded-lg p-8 backdrop-blur-sm">
          <h2 className="text-2xl font-semibold mb-6">What Sets Us Apart?</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="feature-card p-4 rounded-lg bg-white/5">
            ...
            <div className="space-y-4">
              ...
              <div className="feature-card p-4 rounded-lg bg-white/5">
                ...
                <p>As proud members of the Cowichan Valley community, we're invested in making our region even more beautiful, one property at a time.</p>
              </div>
            </div>
          </div>
        </section>
