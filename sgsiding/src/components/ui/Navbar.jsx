      ...
      <div className="container mx-auto flex items-center justify-between px-4 py-3">
        ...
        <div className="text-lg font-bold text-primary business-title">
          <img
            ...
            className="logo"
          />
          <h2 className="nav-title">Custom Exteriors</h2>
        </div>
        ...
        {/* Mobile Menu Button */}
        <button
          className="lg:hidden text-muted hover:text-primary bg-gray-600"
          onClick={toggleMenu}
        >
        ...
        {/* Mobile Navigation */}
        {menuOpen && (
          <nav className="absolute top-16 left-0 w-full shadow-md border-t lg:hidden nav-btns">
